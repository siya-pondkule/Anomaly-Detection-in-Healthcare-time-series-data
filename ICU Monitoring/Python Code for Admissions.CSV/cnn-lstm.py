...
def build_cnn_lstm_autoencoder(seq_len, n_features):
    model = models.Sequential([
        ...
        # Decoder: TimeDistributed Conv1D (simple reconstruction)
...
if __name__ == "__main__":
    ...
    history = cnn_lstm_autoencoder.fit(X_seq, X_seq, epochs=50, batch_size=32, validation_split=0.1, verbose=0)
