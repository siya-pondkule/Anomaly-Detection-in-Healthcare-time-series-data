...
def evaluate_ml_model(y_true, anomaly_scores, contamination_rate):
    # OCSVM score: larger (more positive) is more normal.
    try:
        auc = roc_auc_score(y_true, anomaly_scores)
    except ValueError:
        auc = np.nan
        
    # We want to identify the lowest scores (most anomalous)
...
if __name__ == "__main__":
    ...
    # Train Model (nu is the expected fraction of outliers)
